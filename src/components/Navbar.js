        ...
        {isDev && (
          <button
            ...
            style={{
              background: 'none',
              border: 'none',
              color: location.pathname === '/developer' ? 'var(--color-primary)' : 'var(--text-main)',
              fontWeight: location.pathname === '/developer' ? 700 : 500,
              fontSize: 17,
              cursor: 'pointer',
              padding: 0,
              borderBottom: location.pathname === '/developer' ? '2.5px solid var(--color-primary)' : '2.5px solid transparent',
              transition: 'color 0.2s, border 0.2s',
              backgroundClip: 'padding-box',
              fontFamily: 'var(--font-main)',
            }}
